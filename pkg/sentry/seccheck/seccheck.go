...
type Checker interface {
	...
	RawSyscall(context.Context, SyscallInfo) error
	Syscall(context.Context, SyscallToProto, SyscallInfo) error
...
func (CheckerDefaults) RawSyscall(context.Context, SyscallInfo) error {
	return nil
}

func (CheckerDefaults) Syscall(context.Context, SyscallToProto, SyscallInfo) error {
	return nil
}
